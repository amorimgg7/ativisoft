...
<nav class="sidebar sidebar-offcanvas " id="sidebar" style="background-color:#424d47; color:#fff;">
        <div class="user-profile">
          <!--<div class="user-image">
            <img src="<?php //echo $_SESSION['foto_pessoal'];?>">
          </div>-->
          <div class="user-name">
            <?php echo 'Olá, '.$_SESSION['pnome_pessoa'].' '.$_SESSION['snome_pessoa']?>
          </div>
          ...
          <div class="user-designation">
            ...
            <p>Fornecedor <?php //echo $_SESSION['md_fornecedor'];?></p>-->
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo $_SESSION['dominio'];?>/pages/md_pedido_oracao/pedidoOracao.php">
              <i class="icon-box menu-icon"></i>
              <span class="menu-title">Pedido de Oração</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="<?php echo $_SESSION['dominio'];?>/pages/md_visitante/visitante.php">
              <i class="icon-box menu-icon"></i>
              <span class="menu-title">Form Visitante</span>
            </a>
          </li>
...
-->
          <li class="nav-item" style="display: block;">
            <a class="nav-link" data-toggle="collapse" href="#md_rel" aria-expanded="false" aria-controls="md_rel">
              <i class="icon-disc menu-icon" ></i>
              <span class="menu-title">Relatórios</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="md_rel">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?php echo $_SESSION['dominio'];?>pages/md_rel_visita/relatorios_visita.php">Visitantes</a></li>
              </ul>
            </div>
          </li>
