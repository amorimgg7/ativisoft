                        ...
                        <div class="col-xl-3 flex-column d-flex grid-margin stretch-card">
                            <div class="row flex-grow">
                                <?php
                                    ...
                                    echo '<h4 class="card-title">Emissão do relatório de visitantes</h4>';
                                    ...
                                    echo '<button type="submit" name="rel_visita" id="rel_fechamento_caixa" class="btn btn-lg btn-block btn-outline-warning" style="margin: 5px;"><i class="mdi mdi-file-check"></i>Imprimir Relatório</button>';
