                ...
                <div class="form-group" style="display: flex;">
                            <div class="input-group">
                              <?php 
                                ...
                                echo '      <select name="cd_pais" id="cd_pais"  class="input-group-text" style="display: flex; width:100px;" required>';
                                echo '      <option selected="selected" value="'.$resultado['codigo_pais'].'">'.$resultado['nome_pais'].'</option>';
                                echo $resultado['lista_paises'];
                                echo '      </select>  ';
                                echo '    </div>';
                                echo '    <input type="tel" value="'.$resultado['ddd'].$resultado['numero'].'" name="cad_tel" id="cad_tel" class="form-control form-control-sm" placeholder="Telefone - Whatsapp" require oninput="tel(this)">';
