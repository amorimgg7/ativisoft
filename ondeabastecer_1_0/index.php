...
<body class="container mt-4" onload="detectarOS()">
    ...
    <a href="index2.php" class="btn btn-primary rounded-pill position-fixed bottom-0 end-0 m-4 shadow" style="z-index: 1055;">
        Ir para V2
    </a>
                ...
                foreach ($queryResults as $row) {
                    ...
                    foreach ($row as $key => $value) {
                        if ($key === 'MAPA') {
                            ...
                            if($value === 'ANP'){
                                echo "<td>
                                    https://basedosdados.org/dataset/6ea3e28a-42be-401a-a066-ad87ca931e69?table=3a7cb29a-0bdf-4f44-bab1-d27872e565ff<a style='text-decoration: none;' href='https://www.gov.br/anp/pt-br/centrais-de-conteudo/dados-abertos/criticas-sugestoes-reuso-dados-abertos' target='_blank'>ANP</a>
                                </td>";
                            }else{
                                echo "<td>$value</td>";
                            }
