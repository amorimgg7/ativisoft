<div class="col-lg-12 grid-margin stretch-card">
  <H2>Separação de patrimonio por comodo</H2>
<i type="submit" class="btn btn-success"style="margin:auto; display:none;"id="noprazo">Salão principal</i>
<i type="submit" class="btn btn-warning"style="margin:auto; display:none;"id="parahoje">Secretaria</i>
<i type="submit" class="btn btn-danger"style="margin:auto; display:none;" id="extrapolado">Diretoria</i>
</div>
            ...
            <?php //À FAZER
              ...
              if ($resulta_servico->num_rows > 0){
                ...
                echo '<h4 style="display: inline-block; margin-left: 10px;">Salão principal</h4>';
            ...
            <?php //EM ANDAMENTO
              ...
              if ($resulta_servico->num_rows > 0){
                ...
                echo '<div class="grid-margin stretch-card">';
                echo '<h4 style="display: inline-block; margin-left: 10px;">Secretaria</h4>';
