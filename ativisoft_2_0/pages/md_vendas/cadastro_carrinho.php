        ...
        <div class="content-wrapper" <?php echo $_SESSION['c_body'];?>>
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <!--
                <div class="card-body" id="pergunta1">
                  <div class="template-demo">
                    <h4 class="card-title">Cliente Novo?</h4>
              ...
              <option value='263'>263 Zimbábue</option>
                ...
                ?>
                          ...
                          <?php if($_SESSION['os_servico'] > 0){
                            ...
                            echo '<input value="'.$_SESSION['titulo_orcamento'].'"type="text" name="titulo_orcamento" id="titulo_orcamento" class="aspNetDisabled form-control form-control-sm" placeholder="Título do serviço">';
                            echo '<label for="vcusto_orcamento"></label>';
                            echo '<input value="'.$_SESSION['vcusto_orcamento'].'" type="tel" id="vcusto_orcamento" name="vcusto_orcamento" class="aspNetDisabled form-control form-control-sm" placeholder="Quanto custa este serviço?">';
                ...
                <script>
                //  function limpaOS(){
                //    document.getElementById("limparOS").style.display = "block";
                //    window.alert('Mostrar botão de limpar OS!');
                //  }
                </script>
                <?php
                //  if(isset($_POST['limpaOS'])) {
                //  //  echo '<script>document.getElementById("limparOS").style.display = "block";</script>';
                //    echo "<script>window.alert('Mostrar botão de limpar OS!');</script>";
                //  }
                ?>
...
<?php //cadastra ordem de serviço e consulta para imprimir
          ...
          <?php
//echo '<form action="teste.php" method="post" target="_blank">';
//echo 'Nome: <input type="text" name="nome"><br>';
//echo 'Sobrenome: <input type="text" name="sobrenome"><br>';
//echo 'Telefone: <input type="text" name="telefone"><br>';
//echo 'Observações: <input type="text" name="observacoes"><br>';
//echo 'Data: <input type="text" name="data"><br>';
...
faltaPagar = vtotalServico - vpagServico;
  ...
  mensagem += "O prazo estipulado para entrega é: *" + prazoOrganizado + "*\n\n";
  <?php 
