...
$pathCertificateProd = realpath(__DIR__ . "/producao-567916-AtiviSoft_123.p12"); // Absolute path to the certificate in .pem or .p12 format
...
$pathCertificateHomolog = realpath(__DIR__ . "/producao-567916-AtiviSoft_123.p12"); // Absolute path to the certificate in .pem or .p12 format
...
return [
	...
	"sandbox" => true, //$sandbox, // Optional | Default = false
