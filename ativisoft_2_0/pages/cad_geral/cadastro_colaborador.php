...
atualizarModulo($conn, $cd_pessoa, 'acesso_cameras_0009', $_POST['CAMERAS'] ?? []);
...
//echo "<script>alert('Permissões gravadas com sucesso!');</script>";
                  ...
                  $u->reLoadModulos2($_SESSION['cd_colab'], $_SESSION['cd_empresa']);
              ...
              if($_SESSION['statusCadastrosColab'] == 1){//cadastro de grupo de produtos
                ...
                echo '<span class="card-title">Nome<spam style="color:#f00">*</spam></span>';
                echo '<div class="input-group-prepend">';
                ...
                */
                ...
                echo '<div class="col-sm-6 col-md-4 col-lg-3 col-xl-3">';
                echo '<span class="card-title">Email<spam style="color:#f00">*</spam></span>';
                echo '<div class="input-group-prepend">';
...
if ($result_rel->num_rows > 0) {
    while ($row_rel = $result_rel->fetch_assoc()) {
        ...
        $permissao_cameras     = json_decode($row_rel['acesso_cameras_0009']     ?? '[]', true);
    }
}
...
// ======================================================
$u->mostrarPermissoesParam("Caixa",        $permissao_caixa,         $_SESSION['md_caixa']);
$u->mostrarPermissoesParam("Assistência",  $permissao_assistencia,   $_SESSION['md_assistencia']);
$u->mostrarPermissoesParam("Vendas",       $permissao_venda,         $_SESSION['md_venda']);
$u->mostrarPermissoesParam("Patrimônio",   $permissao_patrimonio,    $_SESSION['md_patrimonio']);
$u->mostrarPermissoesParam("Folha de Ponto", $permissao_folhaponto,  $_SESSION['md_folhaponto']);
$u->mostrarPermissoesParam("Financeiro",   $permissao_financeiro,    $_SESSION['md_financeiro']);
$u->mostrarPermissoesParam("Cadastro",     $permissao_cadastro,      $_SESSION['md_cadastro']);
$u->mostrarPermissoesParam("PDV",          $permissao_pdv,           $_SESSION['md_pdv']);
$u->mostrarPermissoesParam("CAMERAS",      $permissao_cameras,       $_SESSION['md_cameras']);
