        ...
        <div class="content-wrapper" <?php echo $_SESSION['c_body'];?>>
          <div class="row">
            <div class="col-12 grid-margin">
              ...
              <?php
              if(!isset($_SESSION['concd_cliente'])){
                $_SESSION['concd_cliente'] = 0;
              }
                if(isset($_POST['con_cliente'])) {
                  
                  $query = "SELECT * FROM tb_pessoa WHERE tel1_pessoa = '".$_POST['cd_pais'].$_POST['btntel_cliente']."'";
                  $result = mysqli_query($conn, $query);
                  $row = mysqli_fetch_assoc($result);

                  // Exibe as informações do usuário no formulário
                  if($row) {
                    $_SESSION['concd_cliente'] = $row['cd_pessoa']; 
                  }      
                }
              ...
              <?php
                if(isset($_POST['atualizaCliente'])) {
                  ...
                  pnome_pessoa = '".$_POST['btnpnome_cliente']."',
                  snome_pessoa = '".$_POST['btnsnome_cliente']."',
                  cpf_pessoa = '".$_POST['btncpf_cliente']."',
                  tel1_pessoa = '".$_POST['btntel_cliente']."',
                  email_pessoa = '".$_POST['btnemail_cliente']."'
                  WHERE cd_pessoa = ".$_POST['btncd_cliente']."";
              ...
              <?php
                if($_SESSION['concd_cliente'] > 0){
                  ...
                  $select_cliente = "SELECT * FROM tb_pessoa WHERE cd_pessoa = '".$_SESSION['concd_cliente']."'";
                  ...
                  if($row_cliente) {
                      ...
                      echo '<input value="'.$row_cliente['cd_pessoa'].'" name="btncd_cliente" type="text" id="btncd_cliente" class="aspNetDisabled form-control form-control-sm" readonly style="display: block;"/>';
                      echo '<label for="btnpnome_cliente">Nome</label>';
                      echo '<input value="'.$row_cliente['pnome_pessoa'].'" name="btnpnome_cliente" type="text" id="btnpnome_cliente" maxlength="40"   class="aspNetDisabled form-control form-control-sm"/>';
                      echo '<label for="btnsnome_cliente">sobrenome</label>';
                      echo '<input value="'.$row_cliente['snome_pessoa'].'" name="btnsnome_cliente" type="text" id="btnsnome_cliente" maxlength="40"   class="aspNetDisabled form-control form-control-sm"/>';
                      echo '<label for="btncpf_cliente">CPF</label>';
                      echo '<input value="'.$row_cliente['cpf_pessoa'].'" oninput="cpf(this)" name="btncpf_cliente" type="tel"  id="btncpf_cliente" class="aspNetDisabled form-control form-control-sm"/>';
                      echo '<label for="btntel_cliente">Telefone</label>';
                      echo '<input value="'.$row_cliente['tel1_pessoa'].'" name="btntel_cliente" type="tel"  id="btntel_cliente" class="aspNetDisabled form-control form-control-sm"/>';
                      echo '<label for="btnemail_cliente">Email</label>';
                      echo '<input value="'.$row_cliente['email_pessoa'].'" name="btnemail_cliente" type="email"  id="btnemail_cliente" maxlenth="40" class="aspNetDisabled form-control form-control-sm"/>';
                    ...
                    //echo '<label for="btntel_cliente">Telefone</label>';
                    echo '<input value="'.$_SESSION['tel1_pessoa'].'" name="btntel_cliente" type="tel"  id="btntel_cliente" oninput="tel(this)" readonly/>';
                    ...
                    echo '<script>document.getElementById("btntel_cliente").value = "'.$_SESSION['tel1_pessoa'].'"</script>';
