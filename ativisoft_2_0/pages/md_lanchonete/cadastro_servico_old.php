          ...
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                ...
                <?php  //echo '<h1>'.$_SESSION['vcusto_orcamento'].'</h1>';?>
                <?php
                          ...
                          <form method="POST">
                            <div  class="typeahead">
                              ...
                              <div class="form-group-custom">
                                ...
                                <input name="tel_cliente" type="tel" <?php //session_start(); echo $_SESSION['contel_cliente'];?> id="tel_cliente" oninput="tel(this)" class=" form-control form-control-sm" readonly/>
                ...
                <?php
                  if(isset($_POST['contel_cliente'])) { //CHAMAR CLIENTE CADASTRADO PARA SESSION
                    ...
                    $select_cliente = "SELECT * FROM tb_pessoa WHERE tel1_pessoa = '".$_POST['cd_pais'].$_POST['contel_cliente']."'";
                    ...
                    if($row) {
                      ...
                      if($row_divida) {
                        $_SESSION['divida_cliente'] = "Dívida ativa de R$: ".number_format($row_divida['saldo_faltante'], 2, ',', '.')." <a class='btn btn-block btn-lg btn-warning' style='margin: 5px;' href='".$_SESSION['dominio']."pages/md_assistencia/acompanha_servico.php?cnpj=".$_SESSION['cnpj_empresa']."&tel=".$row['tel1_pessoa']."'>Saiba Mais</a>";
                        echo "<script>window.alert('A L E R T A ! \\nO cliente ".$row['pnome_pessoa']." ".$row['snome_pessoa']." está com uma dívida ativa de R$:".number_format($row_divida['saldo_faltante'], 2, ',', '.')."');</script>";
                      }else{
                ...
                <?php
                  if(isset($_SESSION['os_cliente'])){
                    if($_SESSION['os_cliente'] > 0 && (!isset($_SESSION['os_servico']) || $_SESSION['os_servico'] == 0)){
                      ...
                      echo '<input value="'.$_SESSION['os_cliente'].'" name="showcd_cliente" type="text" id="showcd_cliente" class=" form-control form-control-sm" style="display: none;"/>';
                      echo '</div>';
                      echo '<div class="form-group-custom">';
                      echo '<label for="showpnome_cliente">Nome</label>';
                      echo '<input value="'.$_SESSION['pnome_cliente'].'" name="showpnome_cliente" type="text" id="showpnome_cliente" maxlength="40"   class=" form-control form-control-sm" readonly/>';
                      echo '</div>';
                      echo '<div class="form-group-custom">';
                      echo '<label for="showsnome_cliente">sobrenome</label>';
                      echo '<input value="'.$_SESSION['snome_cliente'].'" name="showsnome_cliente" type="text" id="showsnome_cliente" maxlength="40"   class=" form-control form-control-sm" readonly/>';
                      echo '</div>';
                      echo '<div class="form-group-custom">';
                      echo '<label for="showtel_cliente">Telefone</label>';
                      echo '<input value="'.$_SESSION['tel_cliente'].'" name="showtel_cliente" type="tel"  id="showtel_cliente" oninput="tel(this)" class=" form-control form-control-sm" readonly/>';
                      echo '</div>';
                ...
                <?php
                  if(isset($_POST['lancar'])) { //CADASTRAR SERVICO E CHAMAR SERVICO CADASTRADO PARA SESSION
                    //include("../../partials/load.html");
                    // Atualiza as informações do usuário no banco de dados
                    $insert_servico = "INSERT INTO tb_servico(cd_cliente, cd_filial, obs_servico, prioridade_servico, entrada_servico, prazo_servico, status_servico) VALUES(
                      '".$_SESSION['os_cliente']."',
                      '".$_SESSION['cd_empresa']."',
                      '".$_POST['obs_servico']."',
                    ...
                    $select_servico = "SELECT * FROM tb_servico WHERE cd_filial = '".$_SESSION['cd_empresa']."' AND cd_cliente = '".$_SESSION['os_cliente']."' AND status_servico = 0 ORDER BY cd_servico DESC LIMIT 1";
                    ...
                    if(isset($_POST['con_edit_os'])) {
                      ...
                      $select_cliente = "SELECT * FROM tb_pessoa WHERE cd_pessoa = '".$_SESSION['os_cliente']."'";
                    ...
                    if(isset($_POST['lancarOrcamento'])) {      
                      if($_POST['titulo_orcamento']==false){
                          ...
                          $_SESSION['vcusto_orcamento'] = str_replace(',', '.', $_POST['vcusto_orcamento']);
                          ...
                          $insertOrcamento = "INSERT INTO tb_orcamento_servico(cd_cliente, cd_filial, cd_servico, titulo_orcamento, vcusto_orcamento, tipo_orcamento, status_orcamento) VALUES(
                            '".$_SESSION['os_cliente']."',
                            '".$_SESSION['cd_empresa']."',
                            '".$_SESSION['os_servico']."',
                            '".$_POST['titulo_orcamento']."',
                            '".str_replace(',', '.', $_POST['vcusto_orcamento'])."',
                            'AVULSO',
                            0)
                          ";
                          ...
                          $_SESSION['vcusto_orcamento'] = $_SESSION['orcamento_servico'] + str_replace(',', '.', $_POST['vcusto_orcamento']);
                    ...
                    if(isset($_SESSION['os_servico'])){
                      if($_SESSION['os_servico'] > 0){
                        $query = "SELECT * FROM tb_servico WHERE cd_servico = '".$_SESSION['os_servico']."'";
                        $result = mysqli_query($conn, $query);
                        $row = mysqli_fetch_assoc($result);
                        // Exibe as informações do usuário no formulário
                        if($row) {
                        ...
                        echo '<script>document.getElementById("abrirOS").style.display = "block";</script>';
                        //echo '<h3 class="kt-portlet__head-title">Dados do Cliente</h3> ';
                        echo '<div  class="typeahead" style="display:none;">';
                        
                        echo '<input value="'.$_SESSION['os_cliente'].'" name="showcd_cliente" type="text" id="showcd_cliente" class=" form-control form-control-sm" style="display: none;"/>';
                        
                        echo '<div class="form-group-custom">';
                        echo '<label for="showpnome_cliente">Nome</label>';
                        echo '<input value="'.$_SESSION['pnome_cliente'].'" name="editpnome_cliente" type="text" id="showpnome_cliente" maxlength="40"   class=" form-control form-control-sm" readonly/>';
                        echo '</div>';
                        echo '<div class="form-group-custom">';
                        echo '<label for="showsnome_cliente">sobrenome</label>';
                        echo '<input value="'.$_SESSION['snome_cliente'].'" name="showsnome_cliente" type="text" id="showsnome_cliente" maxlength="40"   class=" form-control form-control-sm" readonly/>';
                        ...
                        echo '<input value="'.$_SESSION['os_servico'].'" type="tel" name="editos_servico" id="editos_servico" class=" form-control form-control-sm" readonly>';
                        echo '</div>';
                        echo '<div class="form-group-custom">';
                        echo '<label for="editobs_servico">Descrição Geral</label>';
                        echo '<input value="'.$_SESSION['obs_servico'].'" type="text" name="editobs_servico" maxlength="999" id="editobs_servico"  class=" form-control form-control-sm" placeholder="Caracteristica geral do serviço">';                              
                        echo '</div>';
                        echo '<div class="form-group-custom">';
                        echo '<label for="editprioridade_servico">Prioridade</label>';
                        echo '<select name="editprioridade_servico" id="editprioridade_servico"  class=" form-control form-control-sm">';                              
                        ...
                        echo '<input value="'.$_SESSION['entrada_servico'].'" type="datetime-local" class=" form-control form-control-sm" style="display: block; " readonly/>';
                        echo '</div>';
                        echo '<div class="form-group-custom">';
                        echo '<label for="editprazo_servico">Prazo</label>';
                        echo '<input value="'.$_SESSION['prazo_servico'].'" name="editprazo_servico" type="datetime-local" id="editprazo_servico" class=" form-control form-control-sm"/>';
                        echo '</div>';
                        ...
                        <?php
                        echo '<button type="button" id="ProdutosServicosBtn" onclick="showSection(\'ProdutosServicos\', \'ProdutosServicosBtn\')" class="btn btn-outline-success" style="text-align:left; display:none;">Mudar para: Serviço Avulso</button>';
                        echo '<button type="button" id="ProdutosServicosCadastroBtn" onclick="showSection(\'ProdutosServicosCadastro\', \'ProdutosServicosCadastroBtn\')" class="btn btn-outline-success" style="text-align:left;">Mudar para: Produtos/Serviços</button>';
                        echo '<script>document.getElementById("listaOrcamento").style.display = "block";</script>';
                        echo '<div id="ProdutosServicos" class="typeahead" style="background-color: #C6C6C6; display: block;">';
                        echo '<h3 class="kt-portlet__head-title">Serviço avulso</h3>';
                        echo '<div class="horizontal-form">';
                        echo '<div class="form-group">';
                        echo '<label for="titulo_orcamento"></label>';
                        echo '<input type="text" name="titulo_orcamento" id="titulo_orcamento" class=" form-control form-control-sm" placeholder="Título do serviço">';
                        echo '<label for="vcusto_orcamento"></label>';
                        echo '<input type="tel" id="vcusto_orcamento" name="vcusto_orcamento" class=" form-control form-control-sm" placeholder="Quanto custa este serviço?">';
                        ...
                        echo '</div>';
                        echo '</div>'; 
                        echo '<div id="ProdutosServicosCadastro" class="typeahead" style="background-color: #C6C6C6; display: none;">';
                        echo '<h3 class="kt-portlet__head-title">Produtos/Serviços</h3>';
                        echo '<div class="horizontal-form">';
                        echo '<div class="form-group">';
                        //echo '<label for="titulo_orcamento"></label>';
                        //echo '<input type="text" name="titulo_orcamento" id="titulo_orcamento" class=" form-control form-control-sm" placeholder="Título do serviço">';
                        //$sql_prod_serv = "SELECT * FROM tb_prod_serv WHERE estoque_prod_serv > 0 AND status_prod_serv = '1' ORDER BY cd_prod_serv;";
										    $sql_prod_serv = "SELECT tps.*, 
                        ...
                        $resulta_prod_serv = $conn->query($sql_prod_serv);
											  if ($resulta_prod_serv->num_rows > 0){
												  echo '<div class="col-lg-12 col-sm-12">';
                          echo '<div class="input-group">';
                          echo '<div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">';
                          echo '<div class="input-group-prepend">';
                          echo '<span id="produto_servico_id1" name="produto_servico_id1" class="input-group-text btn-outline-info">**</span>';
                          echo '<input type="tel" id="produto_servico_id2" name="produto_servico_id2" class="form-control form-control-sm" style="display:none" readonly>';
                          echo '<input type="text" id="produto_servico_nome" name="produto_servico_nome" class="form-control form-control-sm" style="display:none" readonly>';
                          echo '<select name="produto_servico" id="produto_servico" class="form-control" onchange="updatePriceAndCode()">';
                          echo '<option value=""></option>';
                          while ($row_prod_serv = $resulta_prod_serv->fetch_assoc()) {
                            echo '<option value="' . $row_prod_serv['cd_prod_serv'] . '" data-preco="' . $row_prod_serv['preco_prod_serv'] . '" data-estoque="' . $row_prod_serv['estoque_prod_serv'] . '" data-reserva="' . $row_prod_serv['total_reservado'] . '">' . $row_prod_serv['titulo_prod_serv'] . '</option>';
                          }
                          echo '</select>';
                          echo '</div>';
                          echo '</div>';
                          echo '<div class="col-sm-2 col-md-3 col-lg-3 col-xl-3">';
                          echo '<div class="input-group-prepend">';
                          echo '<span class="input-group-text btn-outline-info">Valor</span>';
                          echo '<input type="tel" id="produto_servico_preco" name="produto_servico_preco" class="form-control form-control-sm" readonly>';
                          echo '</div>';
                          echo '</div>';
                          echo '<div class="col-sm-2 col-md-3 col-lg-3 col-xl-3">';
                          echo '<div class="input-group-prepend">';
                          echo '<span class="input-group-text btn-outline-info">QTD</span>';
                          echo '<input type="tel" id="produto_servico_estoque" name="produto_servico_estoque" class="form-control form-control-sm" style="display:block;" readonly>';
                          echo '<input type="tel" id="produto_servico_reserva" name="produto_servico_reserva" class="form-control form-control-sm" style="display:block" readonly>';
                          
                          echo '<input type="tel" id="produto_servico_qtd" name="produto_servico_qtd" value="1" class="form-control form-control-sm" oninput="tel(this), calculateTotal()">';
                          echo '</div>';
                          echo '</div>';
                          echo '<div class="col-sm-2 col-md-3 col-lg-3 col-xl-3">';
                          echo '<div class="input-group-prepend">';
                          echo '<span class="input-group-text btn-outline-info">Total</span>';
                          echo '<input type="tel" id="produto_servico_vtotal" name="produto_servico_vtotal" value="0" class="form-control form-control-sm" readonly>';
                          echo '</div>';
                          echo '</div>';
                          echo '</div>';
                          echo '</div>';
                          echo '<label for="lancarOrcamentoCadastro"></label>';
                          echo '<button type="submit" name="lancarOrcamentoCadastro" id="lancarOrcamentoCadastro" class="btn btn-success">Enviar</button>';                              
											  }else{
                          echo '<div class="col-lg-12 col-sm-12">';
                          echo '<div class="input-group">';  
                          echo '<div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">';
                          echo '<div class="input-group-prepend">';
                          echo '<a href="'.$_SESSION['dominio'].'pages/cad_geral/cadastro_produto.php" class="btn btn-lg btn-block btn-success">Ops, alimente seu estoque para proseguir - Clique Aqui</a>';
                          echo '</div>';
                          echo '</div>';
                          echo '</div>';
                          echo '</div>';
                    ...
                    if(isset($_POST['pagar_servico'])){
                      $insert_pagar_servico = "INSERT INTO tb_movimento_financeiro(cd_filial, tipo_movimento, cd_caixa_movimento, cd_cliente_movimento, cd_colab_movimento, cd_os_movimento, fpag_movimento, valor_movimento, data_movimento, obs_movimento) VALUES(
                        '".$_SESSION['cd_empresa']."',
                        1,
                        '".$_SESSION['cd_caixa']."',
                        '".$_SESSION['os_cliente']."',
                      ...
                      if(isset($_SESSION['os_servico'])){
                        if($_SESSION['os_servico'] > 0){
                        //$_SESSION['vpag_servico'] = 0;
                        //$select_orcamento = "SELECT * FROM tb_orcamento_servico toc, tb_reserva tr WHERE tos.cd_servico = '".$_SESSION['os_servico']."' ORDER BY tos.cd_orcamento ASC";
                        $select_orcamento = "
                          SELECT tr.*, tos.*
                          FROM tb_orcamento_servico tos
                          LEFT JOIN tb_reserva tr ON tr.cd_orcamento = tos.cd_orcamento
                          WHERE tos.cd_servico = '" . $_SESSION['os_servico'] . "' AND tos.cd_filial = '" . $_SESSION['cd_empresa'] . "'
                        ...
                        while($row_orcamento = $result_orcamento->fetch_assoc()) {
                          ...
                          if($row_orcamento['tipo_orcamento'] == 'AVULSO'){
                            ...
                            echo '<input value="'.$row_orcamento['cd_orcamento'].'" name="listaid_orcamento" id="listaid_orcamento" class=" form-control form-control-sm" style="display:none;">';
                            echo '<input value="'.$row_orcamento['tipo_orcamento'].'" name="listatipo_orcamento" id="listatipo_orcamento" type="text" class=" form-control form-control-sm" style="display:none">';
                            echo '<input value="'.$row_orcamento['titulo_orcamento'].'" name="listatitulo_orcamento" id="listatitulo_orcamento" type="text" class=" form-control form-control-sm" readonly>';
                            echo '</div>';
                            echo '</div>';
                            echo '<div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">';
                            echo '<div class="input-group-prepend">';
                            echo '<span class="input-group-text btn-outline-info">SubTotal</span>';
                            echo '<input value="'.$row_orcamento['vcusto_orcamento'].'" name="listavalor_orcamento" id="listavalor_orcamento" type="tel" class=" form-control form-control-sm" placeholder="" readonly>';
                            ...
                            $_SESSION['vcusto_orcamento'] = round($vtotal, 2);
                            ...
                            echo '<div class="input-group-prepend">';
                            echo '<span class="input-group-text btn-outline-info">Valor</span>';
                            echo '<input value="'.$row_orcamento['vprod_orcamento'].'" name="listavalor_orcamento" id="listavalor_orcamento" type="tel" class=" form-control form-control-sm" placeholder="" readonly>';
                            echo '</div>';
                            echo '</div>';
                            echo '<div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">';
                            echo '<div class="input-group-prepend">';
                            echo '<span class="input-group-text btn-outline-info">QTD</span>';
                            echo '<input value="'.$row_orcamento['qtd_orcamento'].'" name="listaqtd_orcamento" id="listaqtd_orcamento" type="tel" class=" form-control form-control-sm" placeholder="" readonly>';
                            echo '</div>';
                            echo '</div>';
                            echo '<div class="col-sm-6 col-md-3 col-lg-3 col-xl-3">';
                            echo '<div class="input-group-prepend">';
                            echo '<span class="input-group-text btn-outline-info">SubTotal</span>';
                            echo '<input value="'.$row_orcamento['vcusto_orcamento'].'" name="listavalor_orcamento" id="listavalor_orcamento" type="tel" class=" form-control form-control-sm" placeholder="" readonly>';
                            echo '<input value="'.$row_orcamento['qtd_reservado'].'" name="qtd_reservado" id="qtd_reservado" type="tel" class=" form-control form-control-sm" placeholder="" style="display:none;" readonly>';
                            echo '<input value="'.$row_orcamento['qtd_efetivado'].'" name="qtd_efetivado" id="qtd_efetivado" type="tel" class=" form-control form-control-sm" placeholder="" style="display:none;" readonly>';
                            
                            if($row_orcamento['qtd_reservado'] == $row_orcamento['qtd_efetivado']){
                              echo '<input type="submit" value="X" name="listaremover_orcamento_efetivado" id="listaremover_orcamento_efetivado" class="btn btn-warning">';
                            }else{
                              echo '<input type="submit" value="X" name="listaremover_orcamento" id="listaremover_orcamento" class="btn btn-danger">';
                            }
                            ...
                            echo '</form>';
                            $vtotal = $vtotal + $row_orcamento['vcusto_orcamento'];
                            //round( $_POST['vcusto_orcamento'], 2) = $vtotal;
                            $_SESSION['vcusto_orcamento'] = round( $vtotal, 2) ;
                          }
                          echo '</div>';
                          echo '</div>';
                      ...
                      $select_orcamento_cadastro = "SELECT * FROM tb_orcamento_servico WHERE tipo_orcamento = 'CADASTRO' AND cd_servico = '".$_SESSION['os_servico']."' ORDER BY cd_orcamento ASC";
                      $result_orcamento_cadastro = mysqli_query($conn, $select_orcamento_cadastro);
                      //$_SESSION['vcusto_orcamento'] = 0;
                      $count = 0;
                      //$vtotal = 0;
                      while($row_orcamento_cadastro = $result_orcamento_cadastro->fetch_assoc()) {
                        echo '<div name="listaOrcamento" id="listaOrcamento" class="typeahead">';
                        echo '<form method="POST">';
                        echo '<div class="horizontal-form">';
                        echo '<div class="form-group">';
                        ...
                        echo '<input value="'.$row_orcamento_cadastro['cd_orcamento'].'" name="listaid_orcamento" id="listaid_orcamento" class=" form-control form-control-sm" style="display:none;">';
                        echo '<label for="listatitulo_orcamento">'.$count.'</label>';
                        echo '<input value="'.$row_orcamento_cadastro['titulo_orcamento'].'" name="listatitulo_orcamento" id="listatitulo_orcamento" type="text" class=" form-control form-control-sm" readonly>';
                        echo '<label for="listavalor_orcamento">R$: </label>';
                        echo '<input value="'.$row_orcamento_cadastro['vcusto_orcamento'].'" name="listavalor_orcamento" id="listavalor_orcamento" type="tel" class=" form-control form-control-sm" placeholder="" readonly>';
                        echo '<label for="listaremover_orcamento"></label>';
                        //echo '<input type="submit" value="X" onclick="location.reload()" name="listaremover_orcamento" id="listaremover_orcamento" class="btn btn-danger">';
                        echo '<input type="submit" value="X" name="listaremover_orcamento" id="listaremover_orcamento" class="btn btn-danger">';
                        
                        $vtotal = $vtotal + $row_orcamento_cadastro['vcusto_orcamento'];
                        $_SESSION['vcusto_orcamento'] = round($vtotal, 2);
                        echo '</div>';
                        echo '</div>';
                        echo '</form>';
  ...
  if ($_POST['confirmacao'] === 'sim') {
    ...
    if (mysqli_query($conn, $removeOrcamentoServico)) {
      ...
      // Lógica para "Cancelar"
                      ...
                      //echo '<p>vcusto_orcamento: '.$_SESSION['vcusto_orcamento'].'</p>';
                      //echo '<p>orcamento_servico: '.$_SESSION['orcamento_servico'].'</p>';
                      //echo '<p>listavalor_orcamento: '.$_SESSION['listavalor_orcamento'].'</p>';
                      //echo '<p>vpag_servico: '.$_SESSION['vpag_servico'].'</p>';
                      //echo '<p>vtotal: '.$vtotal.'</p>';

                      echo '<div  class="typeahead" style="background-color: #C6C6C6; display:none;">';
                      echo '<div class="horizontal-form">';
                      echo '<div class="form-group">';
                      
                      //$_SESSION['falta_pagar_servico'] = $_SESSION['vcusto_orcamento'] - $_SESSION['vpag_servico'];
                        echo '<label for="showobs_servico">Total:</label>';
                        echo '<input value="'.$_SESSION['vcusto_orcamento'].'" type="tel" name="btnvcusto_orcamento" id="btnvcusto_orcamento" class=" form-control form-control-sm" readonly>';
                        echo '<label for="showobs_servico">Pago:</label>';
                        echo '<input value="'.$_SESSION['vpag_servico'].'" type="tel" name="btnvpag_orcamento" id="btnvpag_orcamento" class=" form-control form-control-sm" readonly>';
                        echo '<label for="showobs_servico">Falta:</label>';
                        echo '<input value="'.$_SESSION['falta_pagar_servico'].'" type="tel" name="btn_falta_pagar_orcamento" id="btn_falta_pagar_orcamento" class=" form-control form-control-sm" readonly>';
                      ...
                      if($_SESSION['vcusto_orcamento'] == 0){
                      }else{
                        echo '<form method="POST">';
                        echo '<div  class="typeahead" id="totalizador" name="totalizador" style="display: none;">';
                        echo '<label for="btncd_servico">OS</label>';
                        echo '<input value="'.$_SESSION['os_servico'].'" type="tel" name="btncd_servico" id="btncd_servico" class=" form-control form-control-sm">';
                        echo '</div>';
                      ...
                      echo '</form>';
                        ...
                        //echo '<div class="card">';
                        //echo '<h1>'.$_SESSION['tela_movimento_financeiro'].'</h1>';
                      ...
                      //echo '<h3 class="kt-portlet__head-title">Dados do Cliente</h3> ';
                      echo '<div  class="typeahead" id="botoes" name="botoes" style="display:none;">';
                      echo '<input value="'.$_SESSION['os_cliente'].'" name="btncd_cliente" type="text" id="showcd_cliente" class=" form-control form-control-sm" style="display: none;"/>';
                      echo '<label for="btnpnome_cliente">Nome</label>';
                      echo '<input value="'.$_SESSION['pnome_cliente'].'" name="btnpnome_cliente" type="text" id="btnpnome_cliente" maxlength="40"   class=" form-control form-control-sm"/>';
                      echo '<label for="btnsnome_cliente">sobrenome</label>';
                      echo '<input value="'.$_SESSION['snome_cliente'].'" name="btnsnome_cliente" type="text" id="btnsnome_cliente" maxlength="40"   class=" form-control form-control-sm"/>';
                      echo '<label for="btntel_cliente">Telefone</label>';
                      echo '<input value="'.$_SESSION['tel_cliente'].'" name="btntel_cliente" type="tel"  id="btntel_cliente" oninput="tel(this)" class=" form-control form-control-sm"/>';
                      echo '</div>';
                      ...
                      echo '<input value="'.$_SESSION['obs_servico'].'" type="text" name="btnobs_servico" maxlength="999" id="btnobs_servico"  class=" form-control form-control-sm" placeholder="Caracteristica geral do serviço">';
                      echo '<label for="btnprioridade_servico">Prioridade</label>';
                      echo '<select name="btnprioridade_servico" id="btnprioridade_servico"  class=" form-control form-control-sm">';
                      ...
                      echo '<input value="'.$_SESSION['entrada_servico'].'" name="btnentrada_servico" type="datetime-local" id="btnentrada_servico" class=" form-control form-control-sm" />';
                      echo '<label for="btnprazo_servico">Prazo</label>';
                      echo '<input value="'.$_SESSION['prazo_servico'].'" name="btnprazo_servico" type="datetime-local" id="btnprazo_servico" class=" form-control form-control-sm"/>';
                      echo '</div>';
                      ...
                      echo '<input value="'.$_SESSION['vcusto_orcamento'].'" type="tel" name="btnvcusto_orcamento" id="btnvcusto_orcamento" class=" form-control form-control-sm" readonly>';
                      echo '<label for="showobs_servico">Pago</label>';
                      echo '<input value="'.$_SESSION['vpag_servico'].'" type="tel" name="btnvpag_orcamento" id="btnvpag_orcamento" class=" form-control form-control-sm" placeholder="Valor Pago">';
                      echo '<label for="lancarPagamento"></label>';
                      echo '<input type="submit" name="lancarPagamento" id="lancarPagamento" class="btn btn-success"">';
                      echo '</div>';
                      echo '</div>';
