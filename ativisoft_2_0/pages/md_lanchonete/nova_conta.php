              ...
              <div class="card">
                ...
                <?php  
                  ...
                  if(isset($_POST['lancarOrcamento'])) { 
                    $result_orcamento = $u->cadOrcamento('AVULSO', $_POST['cd_cliente'],$_SESSION['cd_empresa'], $_SESSION['cd_filial'], $_POST['cd_venda'], $_POST['titulo_orcamento'], $_POST['vcusto_venda']);
    ...
    // Lógica para "Cancelar"
                    ...
                    if(isset($_POST['limparConta'])){
                      ...
                      if($_SESSION['cd_venda'] > 0){
                        ...
                        $result_financeiro  = $u->movimentoFinanceiro($_SESSION['dt_caixa'], $_SESSION['cd_empresa'], '', $result_venda['cd_venda']);
