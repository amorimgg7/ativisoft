        ...
        <div class="content-wrapper">
          <div class="row">                      
            ...
            //$sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'IA' GROUP BY marca_patrimonio, modelo_patrimonio"; 
              $sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total, SUM(vcompra_patrimonio) AS soma_valores FROM tb_patrimonio WHERE tipo_patrimonio = 'IA' GROUP BY marca_patrimonio, modelo_patrimonio";

              //$sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total, SUM(valor_patrimonio) AS soma_valoresFROM tb_patrimonio WHERE tipo_patrimonio = 'IA' GROUP BY marca_patrimonio, modelo_patrimonio;";
              ...
              if ($resulta->num_rows > 0){
                ...
                while ( $row = $resulta->fetch_assoc()){
                  ...
                  $qtd_fora_de_uso = $row['total'] - $qtd_uso;
                  echo '<td><label class="badge badge-warning">'.$qtd_fora_de_uso.'</label></td>';
                  echo '<td><label class="badge badge-warning">R$: '.$qtd_fora_de_uso.'</label></td>';
                  echo '<td><label class="badge badge-light">R$ ' . $row['soma_valores'] . '</label></td>';
                  echo '</tr>';
                }
                echo '</tbody>';
                echo '</table>';
...
<?php
              //"SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'Impressora' GROUP BY marca_patrimonio, modelo_patrimonio";
              $sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'MM' GROUP BY marca_patrimonio, modelo_patrimonio"; 
              $resulta = $conn->query($sql_tipo);
              if ($resulta->num_rows > 0){
                echo '<div class="col-12 grid-margin">';
                echo '<div class="card">';
                echo '<div class="card-body">';
                echo '<h4 class="card-title">Modem</h4>';
...
<?php
              //"SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'Impressora' GROUP BY marca_patrimonio, modelo_patrimonio";
              $sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'RR' GROUP BY marca_patrimonio, modelo_patrimonio"; 
              $resulta = $conn->query($sql_tipo);
              if ($resulta->num_rows > 0){
                echo '<div class="col-12 grid-margin">';
                echo '<div class="card">';
                echo '<div class="card-body">';
                echo '<h4 class="card-title">Roteador</h4>';
...
<?php
              //"SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'Impressora' GROUP BY marca_patrimonio, modelo_patrimonio";
              $sql_tipo = "SELECT marca_patrimonio, modelo_patrimonio, COUNT(*) AS total FROM tb_patrimonio WHERE tipo_patrimonio = 'SH' GROUP BY marca_patrimonio, modelo_patrimonio"; 
              $resulta = $conn->query($sql_tipo);
              if ($resulta->num_rows > 0){
                echo '<div class="col-12 grid-margin">';
                echo '<div class="card">';
                echo '<div class="card-body">';
                echo '<h4 class="card-title">Switch</h4>';
