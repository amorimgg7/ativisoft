                                ...
                                <?php
                                    ...
                                    if($_SESSION['dt_caixa'] == FALSE)
                                    {
                                        ...
                                        if(isset($_POST['aberturaNormalCaixa'])){
                                            $select_conferirDiaFiscal = "SELECT * FROM tb_caixa_dia_fiscal WHERE cd_filial = ".$_SESSION['cd_empresa']." AND status_caixa_dia_fiscal = 2 AND DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d', strtotime($dataHoraAtual))."'";
                                            ...
                                            $aberturaNormalCaixa = "INSERT INTO tb_caixa(cd_filial, dt_abertura, cd_colab_abertura, saldo_abertura, status_caixa) VALUES(
                                                '".$_SESSION['cd_empresa']."',
                                                '".$_POST['dt_abertura']."',
                                    ...
                                    if($_SESSION['dt_caixa'] == "HOJE")
                                    {
                                        if(isset($_POST['listaremover_pagamento'])) {//DELETE FROM `tb_orcamento_servico` WHERE `tb_orcamento_servico`.`cd_orcamento` = 198
                                            ...
                                            if(isset($_POST['cd_os_movimento']) && $_POST['cd_os_movimento'] > 0){
                                                ...
                                                mysqli_query($conn, $update_os_movimento);
                                                                                ...
                                                                                //cd_movimento
                                                                                //valor_movimento
                                            $removeMovimento = "DELETE FROM tb_movimento_financeiro WHERE cd_filial = ".$_SESSION['cd_empresa']." AND cd_movimento = ".$_POST['cd_movimento']."";
                                        ...
                                        $select_caixa_hoje = "SELECT * FROM tb_caixa WHERE cd_filial = ".$_SESSION['cd_empresa']." AND cd_caixa = '".$_SESSION['cd_caixa']."' ";
                                        //echo '<h3>'.$dia_hoje.'</h3>';
                                        ...
                                        if ($resulta_caixa_hoje->num_rows > 0){ 
                                            ...
                                            echo '</thead>';
                                            echo '<tbody>';
                                            $select_movimento_caixa = "SELECT * FROM tb_movimento_financeiro WHERE cd_filial = ".$_SESSION['cd_empresa']." AND cd_caixa_movimento = '".$_SESSION['cd_caixa']."'";
                                            //insert into tb_caixa(dt_abertura, cd_colab_abertura, saldo_abertura, status_caixa) VALUES('2023-08-12T13:00','1','15','0')
                                            ...
                                            while ( $row_movimento_caixa = $resulta_movimento_caixa->fetch_assoc()){
                                                ...
                                                $select_cliente_movimento = "SELECT * FROM tb_pessoa WHERE cd_pessoa = '".$row_movimento_caixa['cd_cliente_movimento']."'";
                                                ...
                                                if ( $row_cliente_movimento = $resulta_cliente_movimento->fetch_assoc()){
                                                    echo '<td>'.$row_cliente_movimento['pnome_pessoa'].' '.$row_cliente_movimento['snome_pessoa'].'</td>';
                                                }else{echo '<td>- - - -</td>';}
                                                $select_colab_movimento = "SELECT * FROM tb_pessoa WHERE cd_pessoa = '".$row_movimento_caixa['cd_colab_movimento']."'";
                                                $resulta_colab_movimento = $conn->query($select_colab_movimento);
                                                while ( $row_colab_movimento = $resulta_colab_movimento->fetch_assoc()){
                                                    echo '<td>'.$row_colab_movimento['pnome_pessoa'].' '.$row_colab_movimento['snome_pessoa'].'</td>';
                                                }
                                            ...
                                            echo '<td>R$: '.round($total_tudo, 2).'</td>';
