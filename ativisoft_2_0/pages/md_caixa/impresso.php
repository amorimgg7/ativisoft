...
require_once('fpdf/fpdf.php');
    ...
    if (isset($_POST['abrir_caixa'])) {
        ...
        $fl_ocorrencia = $_POST['fl_ocorrencia'];
        ...
        class MeuPDF extends FPDF {
            ...
            function RelFechamentoCaixa($dt_emissao, $dt_inicio, $dt_fim, $dt_emissao_format, $dt_inicio_format, $dt_fim_format, $fl_ocorrencia) {
                ...
                $this->listaCaixas('A4', $dt_inicio_format, $dt_fim_format, $fl_ocorrencia);
...
*/
        ...
        $pdf = new MeuPDF();
        $pdf->RelFechamentoCaixa($dt_emissao, $dt_inicio, $dt_fim, $dt_emissao_format, $dt_inicio_format, $dt_fim_format, $fl_ocorrencia);
