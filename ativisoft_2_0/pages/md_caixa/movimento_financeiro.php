...
if($_SESSION['dt_caixa'] == "HOJE"){
    ...
    if($_SESSION['tela_movimento_financeiro'] == "VENDA_SERVICO"){
        ...
        }else if($_SESSION['cd_cliente'] > 0){
            $select_vpag = "SELECT * FROM tb_movimento_financeiro WHERE cd_cliente_comercial = '".$_SESSION['cd_cliente']."' ORDER BY cd_movimento ASC";
        }
        ...
        if($_SESSION['vpag_servico'] == $_SESSION['vcusto_orcamento']){
            echo '<h6 style="color:#000;">total pago: ('.$_SESSION['vpag_servico'].') - ('.$_SESSION['vcusto_orcamento'].')</h6>';     
        }else{
