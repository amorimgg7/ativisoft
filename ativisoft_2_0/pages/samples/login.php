              ...
              <?php
                if (isset($_POST['email_colab']) && isset($_POST['senha_colab']))
                {
                  ...
                  if (!empty($email_colab) && !empty($senha_colab)) 
                  {
                    ...
                    }elseif($email_empresa == 'uiculinary@gmail.com'){
                        
                      $cnpj_empresa = '63349722000176';
                        $host_cliente       = "ass_".substr($cnpj_empresa, 0, 8).".mysql.dbaas.com.br";
                        //$host_cliente       = "localhost";
                        $usuario_cliente    = "ass_".substr($cnpj_empresa, 0, 8);
                        //$usuario_cliente    = "root";
                        $senha_cliente      = 'GGA@20002021g';
                        //$senha_cliente      = '';
                        $nome_cliente       = "ass_".substr($cnpj_empresa, 0, 8); // Extrai os primeiros 8 dígitos
                        //$nome_cliente       = "assistent_".substr($cnpj_empresa, 0, 8); // Extrai os primeiros 8 dígitos
