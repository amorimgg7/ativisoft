#!/bin/bash
# ================================
# Setup RTMP/HLS + PHP + Bootstrap com snapshots
# Debian 12
# ================================
...
<title>Plataforma de Câmeras</title>
...
<div class="container mt-3">
  <h3 class="text-center">📹 Câmeras Ao Vivo</h3>
...
function loadCameras(){
    $.getJSON('viewcams.php?json=1', function(cameras){
        ...
        // Atualiza só se houve mudança nos status
...
// Atualiza snapshots e status a cada 5 segundos
loadCameras();
