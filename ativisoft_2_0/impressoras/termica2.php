...
require_once('fpdf/fpdf.php');
    ...
    if (isset($_POST['imprimir_os'])) {
        ...
        class MeuPDF extends FPDF {
            ...
            function GerarOrdemServico($showcd_servico, $nome, $sobrenome, $telefone, $showtitulo_servico, $showobs_servico, $showprioridade_servico, $showprazo_servico, $showorcamento_servico, $showvpag_servico) {
                ...
                $this->customHeader('M2', 'Ordem de Serviço', $showcd_servico, );

                $this->dadosCliente('M2', $nome.$sobrenome,'', $telefone, $showobs_servico);
                
                $this->detalheServico('M2', $showprioridade_servico, $showprazo_servico, $showcd_servico);
                
                $this->dadosFinanceiros($showcd_servico, 'M2', $showorcamento_servico, $showvpag_servico);

                $this->customFooter('M2', '');
    ...
    } elseif(isset($_POST['imprimir_retrabalho'])){
        unset($_POST['imprimir_retrabalho']);
        $showcd_servico = $_POST['btncd_servico'];
        $nome = $_POST['btnpnome_cliente'];
        $sobrenome = $_POST['btnsnome_cliente'];
        $telefone = $_POST['btntel_cliente'];
        ...
        $showbtnfl_retrabalho_servico       = $_POST['btnfl_retrabalho_servico'];
        $showdt_inicio_retrabalho_servico   = $_POST['btndt_inicio_retrabalho_servico'];
        $showdt_fim_retrabalho_servico      = $_POST['btndt_fim_retrabalho_servico'];
        $showobs_retrabalho_servico         = $_POST['btnobs_retrabalho_servico'];
        if(!isset($_POST['btnvcusto_orcamento'])){
            $showorcamento_servico = 0;
        }else{
            $showorcamento_servico = $_POST['btnvcusto_orcamento'];
        ...
        class MeuPDF extends FPDF {
            ...
            function GerarOrdemServico($showcd_servico, $nome, $sobrenome, $telefone, $showtitulo_servico, $showprioridade_servico, $showdt_inicio_retrabalho_servico, $showdt_fim_retrabalho_servico, $showobs_retrabalho_servico) {
                $this->AddPage('P', array(80, 1000)); // Tamanho do papel em milímetros
                $this->SetAutoPageBreak(false);
                $this->SetLeftMargin(0);
                $this->SetFont('Arial', 'B', 20);
                ...
                $this->customHeader('M2', 'Garantia Acionada', $showcd_servico);

                $this->dadosCliente('M2', $nome.$sobrenome,'', $telefone, '');
                
                $this->detalheRetrabalhoServico('M2', $showprioridade_servico, $showobs_retrabalho_servico, $showdt_inicio_retrabalho_servico, $showdt_fim_retrabalho_servico, '');
        ...
        // Instanciar a classe MeuPDF e gerar o PDF
        $pdf = new MeuPDF();
        $pdf->GerarOrdemServico($showcd_servico, $nome, $sobrenome, $telefone, $showtitulo_servico, $showprioridade_servico, $showdt_inicio_retrabalho_servico, $showdt_fim_retrabalho_servico, $showobs_retrabalho_servico);
        ...
        class MeuPDF extends FPDF {
            ...
            function GerarViaCliente($nfantasia_filial, $cnpj_filial, $endereco_filial, $saudacoes_filial, $showcd_servico, $showdtinicio_atividade, $showobs_servico, $showprioridade_servico, $showprazo_servico, $showorcamento_servico, $showvpag_servico, $falta_pagar) {
                ...
                $this->SetFont('Arial', 'B', 20);
                $this->Cell(60, 10, '.', 0, 1, 'C');
                $this->customHeader('M2', 'Via do cliente', $showcd_servico, );
                $this->dadosEmpresa('M2', $nfantasia_filial, $cnpj_filial, $endereco_filial);
                $this->detalheServico('M2', $showprioridade_servico, $showprazo_servico, $showcd_servico);
                $this->dadosFinanceiros($showcd_servico, 'M2', $showorcamento_servico, $showvpag_servico);
                $this->customFooter('M2', $saudacoes_filial);
            }
        ...
        $pdf->Output($nomeArquivo, 'D');
            ...
            //echo "<script>window.alert('Usuário atualizado com sucesso!');</script>";
    } elseif(isset($_POST['historico_simples_os'])){
        unset($_POST['historico_simples_os']);
        $showcd_servico = $_POST['btncd_servico'];
        $nome = $_POST['btnpnome_cliente'];
        $sobrenome = $_POST['btnsnome_cliente'];
        $telefone = $_POST['btntel_cliente'];
        ...
        class MeuPDF extends FPDF {
            ...
            function GerarOrdemServico($showcd_servico, $nome, $sobrenome, $telefone, $showtitulo_servico, $showobs_servico, $showprioridade_servico, $showprazo_servico) {
                ...
                $this->customHeader('M1', 'Ultima Atividade', $showcd_servico);

                $this->dadosCliente('M2',$nome.$sobrenome,'', $telefone, $showobs_servico );
                
                $this->detalhesAtividadesServico('M21', $showcd_servico);
        ...
        // Concatenar o número de telefone com o nome do arquivo
        $nomeArquivo = 'HISTORICO_SIMPLES_OS_' . $showcd_servico . '.pdf';

        $pdf->Output($nomeArquivo, 'I');



    } elseif(isset($_POST['historico_detalhado_os'])){
        unset($_POST['historico_detalhado_os']);
        $showcd_servico = $_POST['btncd_servico'];
        $nome = $_POST['btnpnome_cliente'];
        $sobrenome = $_POST['btnsnome_cliente'];
        $telefone = $_POST['btntel_cliente'];
        ...
        class MeuPDF extends FPDF {
            ...
            function GerarOrdemServico($showcd_servico, $nome, $sobrenome, $telefone, $showtitulo_servico, $showobs_servico, $showprioridade_servico, $showprazo_servico) {
                ...
                $this->detalhesAtividadesServico('M22', $showcd_servico);
