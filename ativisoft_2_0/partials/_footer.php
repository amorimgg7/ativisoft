...
<footer class="footer" <?php echo $_SESSION['c_card'];?>>
  <div class="d-sm-flex justify-content-center justify-content-sm-between"<?php echo $_SESSION['c_card'];?>>
    ...
    <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center" <?php echo $_SESSION['c_card'];?>>Version 2.0 | Release: 0.00 <br><p><?php echo "PHP:".phpversion();?></p><h3>B E T A</h3></span>
  </div>
</footer>
