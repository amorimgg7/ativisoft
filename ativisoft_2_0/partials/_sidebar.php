...
?>
          ...
          <li class="nav-item" <?php echo $_SESSION['md_cadastro_menu'];?>>
            ...
            <div class="collapse" id="cadastros">
              ...
              <ul class="nav flex-column sub-menu">
                ...
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('703', 'nav-link', 'Cliente', $_SESSION['dominio'].'/pages/cad_geral/consulta_cliente.php', '', true).'</li>';?>
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('706', 'nav-link', 'Produtos', $_SESSION['dominio'].'/pages/cad_geral/cadastro_produto.php', '', true).'</li>';?>
          ...
          <li class="nav-item" <?php echo $_SESSION['md_cameras_menu'];?>>
            <a class="nav-link" data-toggle="collapse" href="#cameras" aria-expanded="false" aria-controls="cameras">
              <i class="icon-disc menu-icon" <?php echo $_SESSION['c_sidebar']?>></i>
              <span class="menu-title" <?php echo $_SESSION['c_sidebar']?>>Camera</span>
              <i class="menu-arrow" <?php echo $_SESSION['c_sidebar']?>></i>
            </a>
            ...
            <div class="collapse" id="cameras">
              ...
              <ul class="nav flex-column sub-menu">
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('901', 'nav-link', 'Ver Camera(s)', $_SESSION['dominio'].'/pages/md_cameras/ver_camera.php', '', true).'</li>';?>
                <?php if($_SESSION['cd_empresa'] == 1){
                  echo '<li class="nav-item">'.$u->retPermissaoA('901', 'nav-link', 'Ver Cameras', $_SESSION['dominio'].'/pages/md_cameras/ver_cameras.php', '', true).'</li>';
                }?>
              </ul>
            </div>
          ...
          <li class="nav-item" <?php echo $_SESSION['md_financeiro_menu'];?>>
          ...
          <li class="nav-item" <?php echo $_SESSION['md_pdv_menu'];?>>
            ...
            <div class="collapse" id="md_pdv">
              ...
              <ul class="nav flex-column sub-menu">
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('801', 'nav-link', 'Balcão', $_SESSION['dominio'].'/pages/md_pdv/pdv_balcao.php', '', true).'</li>';?>
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('802', 'nav-link', 'Mesa', $_SESSION['dominio'].'/pages/md_pdv/pdv_mesa.php', '', true).'</li>';?>
                <?php echo '<li class="nav-item">'.$u->retPermissaoA('803', 'nav-link', 'Delivery', $_SESSION['dominio'].'/pages/md_pdd/pdv_delivery.php', '', true).'</li>';?>
              </ul>
            </div> 
          </li>

          <li class="nav-item" <?php echo $_SESSION['md_venda_menu'];?>>
