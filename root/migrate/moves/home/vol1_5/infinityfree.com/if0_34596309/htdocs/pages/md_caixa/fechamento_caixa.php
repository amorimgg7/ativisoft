                            ...
                            <div class="row flex-grow">
                                <?php
                                    ...
                                    if($_SESSION['dt_caixa'] == "HOJE")
                                    {
                                        ...
                                        $select_caixa = "SELECT * FROM tb_caixa WHERE cd_caixa = '".$_SESSION['cd_caixa']."'";
                                            ...
                                            while ( $row_caixa = $resulta_caixa->fetch_assoc()){
                                                ...
                                                $select_caixa_colab = "SELECT * FROM tb_colab WHERE cd_colab = '".$row_caixa['cd_colab_abertura']."'";
                                        ...
                                        if(isset($_POST['fechamentoDiaFiscalCaixa'])){
                                            ...
                                            if($row_caixa) {
                                                ...
                                                //}else{
                                                    $select_caixa_dia_fiscal = "SELECT * FROM tb_caixa_dia_fiscal WHERE DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d', strtotime($dataHoraAtual))."'";
                                                    ...
                                                    WHERE DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d', strtotime($dataHoraAtual))."'";//WHERE dt_abertura_dia_fiscal = '".date('Y-m-d')."";
                                    ...
                                    if($_SESSION['dt_caixa'] == "ONTEM")
                                    {
                                        ...
                                        if(isset($_POST['fechamentoDiaFiscalCaixa'])){
                                            ...
                                            if($row_caixa) {
                                                ...
                                                //    echo "<script>window.alert('Fechamento do caixa realizado, Restam outros caixas abertos!');</script>";
                                                //}else{
                                                    $select_caixa_dia_fiscal = "SELECT * FROM tb_caixa_dia_fiscal WHERE DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d', strtotime($dt_caixa_anterior))."'";
                                                    $result_caixa_dia_fiscal = mysqli_query($conn, $select_caixa_dia_fiscal);
                                                    $row_caixa_dia_fiscal = mysqli_fetch_assoc($result_caixa_dia_fiscal);
                                                    if($row_caixa_dia_fiscal) {
                                                        $select_movimento_analitico = $row_caixa_dia_fiscal['movimento_analitico_dia_fiscal'];
                                                    ...
                                                    diferenca_caixa_dia_fiscal = '".($select_diferenca_total + $_POST['total_caixa_diferenca'])."',
                                                    status_caixa_dia_fiscal = 2
                                                    WHERE DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d', strtotime($dt_caixa_anterior))."'";//WHERE dt_abertura_dia_fiscal = '".date('Y-m-d')."";
                                                    mysqli_query($conn, $update_caixa_dia_fiscal);
                                                    echo "<script>window.alert('Encerramento do Dia Fiscal!');</script>";
                                                //}
                                    ...
                                    if($_SESSION['dt_caixa'] == "ANTERIOR")
                                    {
                                        ...
                                        if(isset($_POST['fechamentoDiaFiscalCaixa'])){
                                            ...
                                            if($row_caixa) {
                                                ...
                                                $select_caixa_aberto = "SELECT * FROM tb_caixa WHERE DATE(dt_abertura) = '".date('Y-m-d', strtotime($dt_caixa_anterior))."'";//dt_caixa_anterior
                                                $result_caixa_aberto = mysqli_query($conn, $select_caixa_aberto);
                                                $row_caixa_aberto = mysqli_fetch_assoc($result_caixa_aberto);
                                ...
                                <?php
                                    ...
                                    if(isset($_POST['saidaOperadorCaixa'])){
                                        ...
                                        WHERE DATE(dt_abertura_dia_fiscal) = '".date('Y-m-d')."'";//WHERE dt_abertura_dia_fiscal = '".date('Y-m-d')."";
                                        mysqli_query($conn, $update_caixa_dia_fiscal);
