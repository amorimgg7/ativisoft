              ...
              <div class="card" <?php $_SESSION['c_card'];?>>
                ...
                <?php
                  if($_SESSION['cd_servico'] > 0){
                    ...
                    echo '<input value="'.$_SESSION['obs_servico'].'" type="text" name="btnobs_servico" maxlength="999" id="btnobs_servico"  class="aspNetDisabled form-control form-control-sm" placeholder="Caracteristica geral do serviço" readonly>';
                  ...
                  while($row_atividade = $result_atividade->fetch_assoc()) { //mostrar historico
                    ...
                    if($row_lastatividade) {//MOSTRAR FORMULÁRIO DE ANDAMENTO DA ATIVIDADE ATUAL / ULTIMA ATIVIDADE REGISTRADA
                      ...
                      if($row_lastatividade['titulo_atividade'] == "C"){//ENTREGAR / DEVOLVER OU REABRIR
                        ...
                        echo '<input name="novadataentrega_atividade" type="datetime-local" id="novadataentrega_atividade" class="form-control form-control-sm">';
