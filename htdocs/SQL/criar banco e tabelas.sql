...
CREATE DATABASE erp_123;
use erp_123;

CREATE TABLE tb_colab(
    cd_colab integer PRIMARY KEY AUTO_INCREMENT,
    pnome_colab varchar(40),
    snome_colab varchar(40),
    cpf_colab varchar(40),
    dtnasc_colab varchar(40),
    sexo_colab varchar(40),
    obs_colab varchar(40),
    tel_colab varchar(40),
    obs_tel_colab varchar(40),
    email_colab varchar(40),
    foto_colab varchar(1000),
    senha_colab varchar(40)
);
...
ADD CONSTRAINT fk_rel_orcamento2 FOREIGN KEY (cd_cliente) REFERENCES tb_cliente (cd_cliente);
...
('1','1','15','1', 'DINHEIRO', '61', '2023-08-16 01:21:00', 'Cliente pagou');                                            